...
<body onload="Vreme()" style="background-image: url(img/carousel/healthy-food-3.jpeg); min-height: 300px; background-position: center; background-repeat: no-repeat; background-size: cover; position:">
  <div class="container">
